...
var ZOO_ZAP_ADDRESS = (_ZOO_ZAP_ADDRESS = {}, _ZOO_ZAP_ADDRESS[exports.ChainId.MAINNET] = '0x090D4613473dEE047c3f2706764f49E0821D256e', _ZOO_ZAP_ADDRESS[exports.ChainId.ROPSTEN] = '0x480b021bdCFf73BBe8541E4D389Ca6b25d1e0907', _ZOO_ZAP_ADDRESS[exports.ChainId.OASISETH_MAIN] = '0x85C9065C6b522E71dC8520C35547E158D3013d74', _ZOO_ZAP_ADDRESS[exports.ChainId.OKCHAIN_TEST] = '0x5CEDe17DCb104BaC72C86818ad56D683646a5b7a', _ZOO_ZAP_ADDRESS[exports.ChainId.OASISETH_TEST] = '0xbF35fEec746C7F3AE0D9cee14Cc300C55EB250A1', _ZOO_ZAP_ADDRESS);
...
var DefaultChainToken = (_DefaultChainToken = {}, _DefaultChainToken[exports.ChainId.MAINNET] = {}, _DefaultChainToken[exports.ChainId.ROPSTEN] = {
  ...
  YUZU: /*#__PURE__*/new Token(exports.ChainId.ROPSTEN, '0x015e3f7A499B4bdD2104470b1324d5940C3447AC', 18, 'YUZU', 'YUZU')
  ...
  YUZU: /*#__PURE__*/new Token(exports.ChainId.OASISETH_MAIN, '0xf02b3e437304892105992512539F769423a515Cb', 18, 'YUZU', 'YUZU')
  ...
  YUZU: /*#__PURE__*/new Token(exports.ChainId.OASISETH_TEST, '0x59e573F48D379D95064811e3C59546f2f350bb2b', 18, 'YUZU', 'YUZU')
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || input === nativeToken && pairs[0].involvesToken(WETH[pairs[0].chainId])) ?  invariant(false, 'INPUT')  : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output === nativeToken && pairs[pairs.length - 1].involvesToken(WETH[pairs[0].chainId])) ?  invariant(false, 'OUTPUT')  : void 0;
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    this.inputAmount = tradeType === exports.TradeType.EXACT_INPUT ? amount : IsNative(route.input) ? new CurrencyAmount(nativeToken, amounts[0].raw) : amounts[0];
    this.outputAmount = tradeType === exports.TradeType.EXACT_OUTPUT ? amount : IsNative(route.output) ? new CurrencyAmount(nativeToken, amounts[amounts.length - 1].raw) : amounts[amounts.length - 1];
...
var AttenuationReward = /*#__PURE__*/function () {
  ...
  _proto.getZooRewardBetween = function getZooRewardBetween(start, end) {
    ...
    var getZooReardFromStart = function getZooReardFromStart(end) {
      ...
      var re = new decimal_js.Decimal(_this.zooPerBlock.toString(10)).mul(new decimal_js.Decimal(rest.toString(10)).div(multiply));
      return re;
    };
...
var TradePool = /*#__PURE__*/function () {
  ...
  _proto2.getDayReturn = function getDayReturn(currBlockNo, rewardPrice, archorPrice) {
    ...
    if (JSBI.greaterThan(this.totalLp, JSBI.BigInt(0))) {
      ...
      var oneDayReward = new decimal_js.Decimal(this.rewardConfig.getZooRewardBetween(currBlockNo, currBlockNo + 21600).toString()).div(new decimal_js.Decimal(this.totalLp.toString(10))); // 0.3% fee

      return oneDayReward.div(new decimal_js.Decimal(rewardPrice)).div(new decimal_js.Decimal(archorPrice));
    } else {
      return new decimal_js.Decimal(0);
    }
  };
