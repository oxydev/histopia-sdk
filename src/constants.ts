...
export const ZOO_KEEPER_ADDRESS: { [chainId in ChainId]?: string } = {
  ...
  [ChainId.OASISETH_MAIN]: '0x480b4ca0005AdeA78739d64F12A33DF7162320Dc',
...
export const FACTORY_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.OASISETH_MAIN] :'0x2718C76687E2A9310EAEAcc895730dD9E455e21A',
...
export const ROUTER_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.OASISETH_MAIN] :'0xd461F2dAcFD3150Aa27892A824D46c00512bAF1d',
...
export const ZOO_PARK_ADDRESS: { [chainId in ChainId]?: string } = {
  ...
  [ChainId.OASISETH_MAIN]: '0xb2AFd3147187514C3C265966171833AF9B4d4273',
...
export const ZOO_USDT_SWAP_PAIR_ADDRESS: { [chainId in ChainId]?: string } = {
  ...
  [ChainId.OASISETH_MAIN]: '0xa1dc740355cc9c2989eB65B3a059B9dB87e84359',
...
export const ZOO_SWAP_MINING_ADDRESS: { [chainId in ChainId]?: string } = {
  ...
  [ChainId.OASISETH_MAIN]: '0xd48C4dA33C50A36b3Dba1Bd678993Ee94066be33',
...
export const ZOO_ZAP_ADDRESS: { [chainId in ChainId]?: string } = {
  [ChainId.MAINNET]: '0x090D4613473dEE047c3f2706764f49E0821D256e',
  [ChainId.ROPSTEN]: '0x480b021bdCFf73BBe8541E4D389Ca6b25d1e0907',
  [ChainId.OASISETH_MAIN]: '0xA0f0791872274c9C70D2cECC78B60c3Ce9e27699',
  [ChainId.OKCHAIN_TEST]: '0x5CEDe17DCb104BaC72C86818ad56D683646a5b7a',
